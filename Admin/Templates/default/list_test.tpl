	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="normal">
		<tr class="adminheader">
			<td width="33%">
				...
				<span class="module_title">测试考试表</span> &nbsp;&nbsp; <a href="{CURRENT_MODULE}">{LANG_showall}</a> 
			</td>
			<td>
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	            	<tr>
	            		<td align="right">
							...
							名字: <input type="text" id="TestName" name="TestName" value="{TestName}" size="20" />
...
<form action="{CURRENT_ACT}" method="post" name="frmInfo">
	<table width="100%"  border="0" cellspacing="0" cellpadding="1" class="adminlist">
		<tr class="list_title">
			...
			<th id="orderby" orderfield="TestName" >名字</th>
			<th id="orderby" orderfield="TestDesc" >描述</th>
			<th id="orderby" orderfield="AddTime" >时间</th>
		...
		<tr align="center" class="list_content" onClick="select_thisrow(this);" onDblClick="editItem({RowList.ID})" onmouseover="highlightrow2(this, true);" onmouseout="highlightrow2(this, false);">
			...
			<td>{RowList.TestName}</td>
			<td>{RowList.TestDesc}</td>
