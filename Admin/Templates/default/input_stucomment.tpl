	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="normal">
		<tr class="adminheader">
			<td>
				...
				<span class="module_title">{ButtonCaption}学生评语</span>		
			</td>
		</tr>
	</table>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="5" class="adminform">
		...
		<tr class="info_content">
			...
			<td>
				...
				<script type="text/javascript">autoSelected(document.frmInfo.WeekOfYear, '{WeekOfYear}');</script>
			</td>
		</tr>
		<tr class="info_content">
			<td width="100" align="right" >
			...
			<td>
				...
				<script type="text/javascript">autoSelected(document.frmInfo.Year, '{Year}');</script>
			</td>
		</tr>
